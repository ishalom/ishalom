...
const EN: Catalogue = {
  ...
  'shared.whichGame': 'Which game?',
  // Round 34: the table's evening, and the chips and bar on the felt.
  'shared.chipsLabel': 'Chips at this table',
  'shared.barTitle': 'Share of decisions right',
  'shared.full': 'This table is full: six people are already sitting at it. You can open one of your own.',
  'shared.evening': 'The evening so far · bar: {bar} · chips: {chips}',
  'shared.priciest': 'The evening’s priciest spot: {spot} — wrong {wrong} of {times} times, {cost} units',
  'shared.historyTitle': 'The last hands',
  'shared.historyHand': 'Hand {n}',
  'shared.summaryTitle': 'The evening at the table',
  'shared.summaryHands': '{n} hands',
  ...
  // Round 30: what happened, said as it happens.
  'shared.hand.won': 'won',
  'shared.hand.lost': 'lost',
  'shared.hand.push': 'push',
  'shared.hand.bust': 'bust',
  'shared.hand.now': 'now',
  'shared.act.forfeit': 'time ran out',
  'shared.actsLabel': 'What was played this hand',
  'shared.nextHand': 'Next hand in {n}',
  'shared.firstHand': 'First hand in {n}',
  'shared.leaveHint': 'Leaves the table',
  'shared.analysisTitle': 'This hand, analysed',
  'shared.oops.minor': 'Close — but not quite.',
  'shared.oops.significant': 'Ouch. That one cost you.',
  'shared.oops.blunder': 'Oof. That one is worth remembering.',
  ...
  'shared.handOver': 'The hand is over.',
  ...
  'social.playerLine': '{accuracy}% at the private table, over {hands} hands',
  'social.playerLineAll': '{decisions} decisions in all',
  'social.you': 'You',
  ...
  'welcome.claimed': '{name} is now yours: your code is set, and the name’s history ({n} decisions) is yours with it.',
  'welcome.claimedNew': '{name} is now yours: your code is set.',
...
const HE: Catalogue = {
  ...
  'waiting.go': 'לשולחן',
  'shared.whichGame': 'איזה משחק?',
  // Round 34: the table's evening, and the chips and bar on the felt.
  'shared.chipsLabel': 'הצ׳יפים בשולחן הזה',
  'shared.barTitle': 'אחוז ההחלטות הנכונות',
  'shared.full': 'השולחן מלא — כבר יושבים בו שישה. אפשר לפתוח שולחן משלך.',
  'shared.evening': 'הערב עד עכשיו · בבר: {bar} · בצ׳יפים: {chips}',
  'shared.priciest': 'המקום היקר של הערב: {spot} — טעות ב־{wrong} מתוך {times} פעמים, {cost} יחידות',
  'shared.historyTitle': 'הידיים האחרונות',
  'shared.historyHand': 'יד {n}',
  'shared.summaryTitle': 'הערב בשולחן',
  'shared.summaryHands': '{n} ידיים',
  ...
  // סבב 30: מה קרה, בזמן שזה קורה.
  'shared.hand.won': 'ניצחה',
  'shared.hand.lost': 'הפסידה',
  'shared.hand.push': 'תיקו',
  'shared.hand.bust': 'נשרפה',
  'shared.hand.now': 'עכשיו',
  'shared.act.forfeit': 'נגמר הזמן',
  'shared.actsLabel': 'מה שוחק ביד הזאת',
  'shared.nextHand': 'היד הבאה בעוד {n}',
  'shared.firstHand': 'היד הראשונה בעוד {n}',
  'shared.leaveHint': 'יציאה מהשולחן',
  'shared.analysisTitle': 'ניתוח היד',
  'shared.oops.minor': 'קרוב — אבל לא.',
  'shared.oops.significant': 'אאוץ׳. זה עלה לך.',
  'shared.oops.blunder': 'אוי. את זה כדאי לזכור.',
  ...
  'social.playerLine': '{accuracy}% בשולחן הפרטי, על פני {hands} ידיים',
  'social.playerLineAll': '{decisions} החלטות בסך הכול',
  'social.you': 'אתה',
  ...
  'welcome.claimed': 'השם {name} עכשיו שלך: הקוד שבחרת נשמר, וכל ההיסטוריה של השם ({n} החלטות) עברה אליך.',
  'welcome.claimedNew': 'השם {name} עכשיו שלך: הקוד שבחרת נשמר.',
